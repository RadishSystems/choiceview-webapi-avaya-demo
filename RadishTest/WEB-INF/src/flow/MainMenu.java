 ...
 * Last generated by Orchestration Designer at: 2013-FEB-03  10:24:22 PM
 */
public class MainMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		eventPromptNames.add("MainMenuNoInput");

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (String[])eventPromptNames.toArray(new String[0]), null);
		list.add(event);

		// build the list of prompt names
		eventPromptNames = new java.util.ArrayList(1);
		
		eventPromptNames.add("MainMenuNoMatch");

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (String[])eventPromptNames.toArray(new String[0]), null);
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("one", "1.0"));


		choice = new com.avaya.sce.runtime.Choice("Order Status", "1", true, "exact", "OrderStatusAnnounce", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("two", "1.0"));


		choice = new com.avaya.sce.runtime.Choice("Customer Support", "2", true, "exact", "CustomerService", grammarInfo, true);
		list.add(choice);

		// build the list of grammar information objects for the choice
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("three", "1.0"));


		choice = new com.avaya.sce.runtime.Choice("Repeat", "3", true, "exact", "MainMenu", grammarInfo, true);
		list.add(choice);
